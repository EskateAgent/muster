...
class PermissionsTableSeeder extends Seeder {
  ...
  public function run()
  {
    ...
    $permissions = [
      ...
      ['id' => 18, 'name' => 'user-archived',            'display_name' => 'Archived User',    'Description' => 'view archived users',           'created_at' => new DateTime, 'updated_at' => new DateTime ],
      ...
      ['id' => 19, 'name' => 'league-archived',          'display_name' => 'Archived League',  'Description' => 'view archived leagues',         'created_at' => new DateTime, 'updated_at' => new DateTime ],
      ...
      ['id' => 20, 'name' => 'charter-archived',         'display_name' => 'Archived Charter', 'Description' => 'view archived charters',        'created_at' => new DateTime, 'updated_at' => new DateTime ],
