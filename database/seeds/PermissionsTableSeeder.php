...
class PermissionsTableSeeder extends Seeder {
  ...
  public function run()
  {
    ...
    $permissions = array(
      ...
      ['id' => 5,  'name' => 'user-destroy',             'display_name' => 'Destroy User',     'Description' => 'destroy users',                 'created_at' => new DateTime, 'updated_at' => new DateTime ],
      ...
      ['id' => 9,  'name' => 'league-destroy',           'display_name' => 'Destroy League',   'Description' => 'destroy leagues',               'created_at' => new DateTime, 'updated_at' => new DateTime ],
      ...
      ['id' => 13, 'name' => 'charter-destroy',          'display_name' => 'Destroy Charter',  'Description' => 'destroy charters',              'created_at' => new DateTime, 'updated_at' => new DateTime ],
